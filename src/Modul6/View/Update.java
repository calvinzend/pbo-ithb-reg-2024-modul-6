...
public class Update {
    ...
    static class Frame extends JFrame {
        ...
        private JPanel createInputPage() {
            ...
            NIKValue.setText(ktp.getNIK());
            namaValue.setText(ktp.getNama());
            tempatLValue.setText(ktp.getTempatLahir());
            ttlValue.setDate(ktp.getTanggalLahir());
            alamatValue.setText(ktp.getAlamat());
            KelDesaValue.setText(ktp.getKelDesa());
            RTRWValue.setText(ktp.getRT_RW());
            kecamatanValue.setText(ktp.getKecamatan());
            berlakuHinggaValue.setText(ktp.getBerlakuHingga());
            kotaPembuatanValue.setText(ktp.getKotaPembuatan());

            if (ktp.getJenisKelamin().equalsIgnoreCase("Pria")) {
                priaButton.setSelected(true);
            } else if (ktp.getJenisKelamin().equalsIgnoreCase("Wanita")) {
                wanitaButton.setSelected(true);
            }

            if (ktp.getKewarganegaraan().equalsIgnoreCase("WNI")) {
                WNI.setSelected(true);
                negaraWNA.setEnabled(false);
            } else {
                WNA.setSelected(true);
                negaraWNA.setEnabled(true);
                negaraWNA.setText(ktp.getKewarganegaraan());
            }

            switch (ktp.getGolonganDarah()) {
                case "A":
            ...
            agamaComboBox.setSelectedItem(ktp.getAgama());
            statusBox.setSelectedItem(ktp.getStatusPerkawinan());
            String[] pekerjaanArray = ktp.getPekerjaan().split(", ");
            for (String pekerjaan : pekerjaanArray) {
                switch (pekerjaan.trim()) {
            ...
            fotoValue.setText(ktp.getFotoPath());
            tandaTanganValue.setText(ktp.getTandaTanganPath());
            tanggalPembuatanChooser.setDate(ktp.getTanggalPembuatan());
